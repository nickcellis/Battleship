...
function getRobotic() {
    // Changed: get the closest robots to the submarine
    /*var submarine = getSubmarine();
    if (submarine == null) {
        return null;
    }
    var robotic = null;
    ...
    for (var x = 0; x < gridSize; x++) {
        for (var y = 0; y < gridSize; y++) {
            ...
            var distance = getDistanceToSubmarine(cell);
    ...
    // DEBUG: console.log(lastDist + "[" + robotic.cellX + ", " + robotic.cellY + "]");
